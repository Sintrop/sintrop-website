    ...
    <section className="w-full mt-10 lg:mt-20 bg-green-3 py-10">
      <div className="container mx-auto px-5 lg:px-20 flex flex-wrap justify-between gap-5">
        <div className="flex flex-col w-full lg:max-w-[48%]">
          <h3 className="text-2xl md:text-4xl text-green-1">
            {t("featuredApp")}
          </h3>
          <h4 className="text-white text-2xl mt-3">
          ...
          <Link
            ...
            className="bg-green-1 h-10 rounded-md px-10 flex items-center justify-center text-white font-semibold mt-5"
          >
            {t("knowMore")}
          </Link>
        </div>
